...
const Spin = () => {
  ...
  return (
    <div className="w-full bg-slate-900 bg-opacity-70 overflow-hidden">
      <div
        id="cover"
      ...
      >
        <div className="w-full h-full relative flex justify-center items-center">
          <div className="w-[80%] flex flex-wrap h-fit pt-6 pb-3 px-3 md:w-[50%] lg:w-[20%] absolute bg-black bg-opacity-90 rounded-tr-[40%] rounded-bl-[40%] border-2 border-white">
            ...
            <button
              className="px-3 py-1 bg-blue-500 text-white mx-auto mt-3 rounded-md font-bold"
              onClick={logout}
            >
              OK
            </button>
      ...
      <div className="py-5">
        <div className="max-w-sm mx-auto px-10 py-3">
      ...
      <div className="flex justify-center items-center pt-10 pb-20">
        ...
        >
          ...
          <div className="wheel absolute top-0 left-0 w-full h-full bg-[#fff] rounded-[50%] overflow-hidden ">
            <div
              className="number"
